...
public class BinaryVersion {
	...
	public String toString() {
		return "BinaryVersions{" + "versionFullPath='" + versionFullPath + '\'' + ", version='" + version + '\'' + '}';
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(versionFullPath, that.versionFullPath) && Objects.equals(version, that.version);
	}
